# AImee POC Implementation Roadmap (Docker + Runpod Edition)
...
## Phase 2 — Premium Brain (OpenAI Realtime)
- Add OpenAI Realtime connection from backend container
- Stream audio through LiveKit
- Round-trip conversation working end-to-end

Deliverable: AImee speaks with Realtime quality.
...
- Test live switching between Realtime and Sesame
