...
export class ExperienceAgent extends BaseAgent {
  ...
  public readonly description = 'Provides experiential recommendations, atmosphere insights, and activity suggestions';
  ...
  private readonly systemPrompt = `You are the Experience agent for AImee, a GPS-triggered tour guide system. Your role is to:
