...
export class NavigatorAgent extends BaseAgent {
  ...
  public readonly description = 'Handles navigation, location awareness, and tour flow management';

  private readonly navigationKeywords = [
  ...
  private readonly systemPrompt = `You are the Navigator agent for AImee, a GPS-triggered tour guide system. Your role is to:
